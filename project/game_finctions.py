...
def check_keydown_events(screen, ai_settings, stats, scoreboard, event, ship, aliens, bullets):
    """Respond to key presses."""

    if event.key == pygame.K_q:
        sys.exit()
    elif event.key == pygame.K_p:
        start_game(ai_settings, stats, screen, scoreboard, aliens, ship, bullets)
        # stats.reset_stats()
...
def check_events(ai_settings, screen, stats, scoreboard, ship, aliens, bullets, play_button):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(screen, ai_settings, stats, scoreboard, event, ship, aliens, bullets)
...
def start_game(ai_settings, stats, screen, scoreboard, aliens, ship, bullets):
    ...
    stats.reset_stats()
    scoreboard.__init__(screen, stats)
    stats.game_active = True
